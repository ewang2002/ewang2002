...
<details>
<summary>⌨️ Programming Languages & Technologies.</summary>
<br> 
...
Aside from programming languages, most of my projects will make use of (some subset of) the following: [MongoDB](https://www.mongodb.com/), [Node.js](https://nodejs.org/en/), and [.NET](https://dotnet.microsoft.com/en-us/).
<p align="center">
...
If you are looking for some of my older and/or abandoned projects, check out my [sandbox organization](https://github.com/ewang2002-sandbox).
  
<details>
<summary>⚒️ Active Projects</summary>
<br>
...
<br>
  ...
  - Projects in _Maintenance Mode_ will receive periodic updates, which may include bug fixes and minor enhancements.
  - Projects in _Archive Mode_ will not receive any updates whatsoever.

  | Project Name | Description | Technologies | Status | 
  | ------------- | ------------- | ------------- | ------------- |
  | [rubot](https://github.com/AWaffleInc/rubot) | A Discord bot which uses scraped CAPE data, WebReg wrapper API, and cached WebReg course data to give users the ability to get course and instructor information without needing to log into TritonLink. Also contains random utility functions. | TypeScript, Node.js | Maintenance Mode (March 2022 - ?) |
...
You are, of course, free to email me. However, I cannot guarantee a response if you contact me by email.
